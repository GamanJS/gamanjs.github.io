...
> **Catatan:** Urutan `mount()` untuk middleware memengaruhi urutan eksekusi berdasarkan priority. Lihat [Middleware](/id/docs/overview/middlewares) untuk detail priority system.
